...
`.trim(),
	},
	{
		...
		showOnUpdate: true,
		bannerUrl: 'operon-2-6-0-setreminders.png',
		body: `
### Kairélys compatibility
- Updated the task engine to the complete Operon **2.6.0** baseline while preserving the
  versioned public API V1 used by the Optimike Bridge and MCP.
- Preserved Operon's Markdown task format and canonical \`operonId\` field so no task-data
