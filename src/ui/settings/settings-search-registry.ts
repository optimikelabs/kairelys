...
export const OPERON_SETTINGS_SEARCH_REGISTRY: readonly OperonSettingsSearchEntry[] = [
	...
	section('views', 'viewsTables', 'tablePresets', 'settings', 'tablePresets', 'tablePresetsDesc', ['table', 'operon table', 'table presets', 'table preset controls', 'preset controls', 'columns', 'summaries', 'reporting']),
