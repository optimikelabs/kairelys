...
export const OPERON_SETTINGS_SEARCH_REGISTRY: readonly OperonSettingsSearchEntry[] = [
	...
	section('settings', 'coreGeneral', 'legacyStorageCleanup', 'settings', 'legacyStorageCleanupTitle', 'legacyStorageCleanupSearchDesc', ['storage', 'storage cleanup', 'legacy storage', '.operon', 'plugin storage', 'Obsidian Sync']),

	section('taxonomy', 'corePipelines', 'pipelines', 'settings', 'tabPipelines', 'pipelinesDesc', ['pipeline', 'workflow', 'workflow statuses', 'status', 'status color', 'status icon', 'scheduled target', 'tracking target', 'finished status', 'cancelled status']),
	section('taxonomy', 'corePriority', 'priorities', 'settings', 'tabPriority', 'priorityDesc', ['priority', 'priority rank', 'priority order', 'default priority', 'priority color', 'priority icon', 'sorting', 'planning']),
	...
	section('automation', 'tasksRelationships', 'parentChildTaskInheritance', 'settings', 'parentChildTaskInheritance', 'parentChildTaskInheritanceDesc', ['parent child inheritance', 'child task inheritance', 'inherited fields', 'copy parent fields', 'relationships']),
	...
	e('ui', 'mobileCalendar', 'calendarMobileDefaultSourcePresetId', 'settings', 'calendarMobileDefaultSourcePreset', 'calendarMobileDefaultSourcePresetDesc', 'dropdown', ['mobile', 'phone', 'mobile calendar preset', 'calendar preset']),
